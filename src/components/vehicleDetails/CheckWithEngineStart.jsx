...
function CheckWithEngineStart() {
  ...
  useEffect(() => {
    const savedRatings = localStorage.getItem("CheckWithEngineStart");
    if (savedRatings) {
  ...
  const data = [
    ...
    { id: 8, attribute: "Sudden accelarate" },
    { id: 9, attribute: "No starting delay" },
    { id: 10, attribute: "Engine mount" },
    { id: 11, attribute: "Engine accelarates smoothly" },
  ];
...
export default CheckWithEngineStart;
