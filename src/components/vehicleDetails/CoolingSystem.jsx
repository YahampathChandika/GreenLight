...
function CoolingSystem() {
  ...
  const data = [
    ...
    { id: 18, attribute: "Radiator complete" },
    { id: 19, attribute: "Radiator cap / Pressure cap" },
    { id: 20, attribute: "Radiator fan electric" },
    { id: 21, attribute: "Radiator fan belt drive" },
    { id: 22, attribute: "Fan guard and fan motor" },
    { id: 23, attribute: "Expansion tank" },
    { id: 24, attribute: "Upper hose" },
    { id: 25, attribute: "Lower hose" },
    { id: 26, attribute: "Bypass hose" },
    { id: 27, attribute: "Fan belt" },
    { id: 28, attribute: "Water pump" },
    { id: 29, attribute: "Thermostal value" },
    { id: 30, attribute: "Coolent" },
    { id: 31, attribute: "Water jacket" },
    { id: 32, attribute: "Oil cooler" },
    { id: 33, attribute: "Cylinder head gasket" },
    { id: 34, attribute: "Temperature sensor" },
  ];
