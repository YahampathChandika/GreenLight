...
function EngineMissIdling() {
  ...
  const data = [
    ...
    { id: 16, attribute: "Spark plug" },
    { id: 17, attribute: "Ig coil" },
    { id: 18, attribute: "Ignition plug wire" },
    { id: 19, attribute: "C.B point / Distributor" },
    { id: 20, attribute: "Engine Compressor" },
    { id: 21, attribute: "Fuel level / Fuel pressure" },
    { id: 22, attribute: "Fuel filter" },
    { id: 23, attribute: "Throttle body" },
    { id: 24, attribute: "Injector pump" },
    { id: 25, attribute: "Injector nosels / Injectors" },
    { id: 26, attribute: "Sensors" },
    { id: 27, attribute: "Wireing / electrical" },
    { id: 28, attribute: "E C U" },
    { id: 29, attribute: "Timing" },
    { id: 30, attribute: "Need tuneup" },
  ];
