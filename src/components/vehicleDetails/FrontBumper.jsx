...
function FrontBumper() {
  ...
  const data = [
    ...
    { id: 11, attribute: "Elignment" },
    { id: 12, attribute: "No evidence of major damage" },
    { id: 13, attribute: "No re paint" },
    { id: 14, attribute: "Existing point condition" },
    { id: 15, attribute: "No scratches" },
    { id: 16, attribute: "No corosoin" },
    { id: 17, attribute: "Fog lamp L.H.S." },
    { id: 18, attribute: "Fog lamp R.H.S." },
    { id: 19, attribute: "No plate" },
    { id: 20, attribute: "Trim molding / crome line" },
  ];
