...
function FrontLightings() {
  ...
  const data = [
    ...
    { id: 13, attribute: "Low beam L.H.S." },
    { id: 14, attribute: "Low beam R.H.S." },
    { id: 15, attribute: "High beam L.H.S." },
    { id: 16, attribute: "High beam R.H.S" },
