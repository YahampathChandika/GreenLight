...
function InteriorInspection() {
  ...
  useEffect(() => {
    const savedRatings = localStorage.getItem("InteriorInspection");
    if (savedRatings) {
  ...
  const handleRatingChange = (attribute, rating) => {
    ...
    localStorage.setItem("InteriorInspection", JSON.stringify(updatedRatings));
  };
  ...
  const data = [
    ...
    { id: 4, attribute: "Power/ Winker mirror control switches" },
    ...
    { id: 19, attribute: "Dual A/C" },
    { id: 20, attribute: "Heaters" },
    { id: 21, attribute: "Dashboard condition" },
    ...
    { id: 54, attribute: "Under Front Passenger’s Magic seat" },
    { id: 55, attribute: "Rear arm rest" },
    { id: 56, attribute: "Seat cover leather" },
    { id: 57, attribute: "Seat cover Fabric " },
    { id: 58, attribute: "Original car mat seat  " },
    { id: 59, attribute: "Door lamps" },
    { id: 60, attribute: "Hood lamps" },
    { id: 61, attribute: "Spot lamps" },
    { id: 62, attribute: "Hood lamps" },
    { id: 63, attribute: "Electric seats" },
    { id: 64, attribute: "Hood upholstery" },
    { id: 65, attribute: "Sun wisers" },
    { id: 66, attribute: "Rear view camera" },
    { id: 67, attribute: "Sunroof operation" },
    { id: 68, attribute: "Power outlet" },
  ];
