...
function MainDataMonitorHybrid() {
  ...
  const data = [
    ...
    { id: 2, attribute: 'HV battery maximum cell voltage' },
    { id: 3, attribute: 'HV battery minimum cell voltage' },
    { id: 4, attribute: 'HV battery module maximum temperature (°C)' },
    { id: 5, attribute: 'HV battery module minimum temperature (°C)' },
    { id: 6, attribute: 'HV total voltage (V)' },
    { id: 7, attribute: 'HV battery usable capacity' },
    { id: 8, attribute: 'S.O.C' },
    { id: 9, attribute: 'S.O.C after IO-ON' },
    { id: 10, attribute: 'States of charge maximum' },
    { id: 11, attribute: 'States of charge minimum' },
    { id: 12, attribute: 'Travel milage' },
    { id: 13, attribute: 'Travel milage after battery removed' },
    { id: 14, attribute: 'Travel milage after trouble happened' },
    { id: 15, attribute: 'Full data report' },
  ];
