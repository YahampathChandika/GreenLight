...
function QuarterPanelRHS() {
  ...
  useEffect(() => {
    const savedRatings = localStorage.getItem("QuarterPanelRHS");
    if (savedRatings) {
  ...
  const handleRatingChange = (attribute, rating) => {
    ...
    localStorage.setItem("QuarterPanelRHS", JSON.stringify(updatedRatings));
  };
...
export default QuarterPanelRHS;
