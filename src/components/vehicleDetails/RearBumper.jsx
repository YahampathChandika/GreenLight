...
function RearBumper() {
  ...
  const data = [
    ...
    { id: 9, attribute: "Trim molding / crome line" },
    { id: 10, attribute: "Elignment" },
    { id: 11, attribute: "No evidence of major damage" },
    { id: 12, attribute: "No re paint" },
    { id: 13, attribute: "Existing point condition" },
    { id: 14, attribute: "No scratches" },
    { id: 15, attribute: "No corosoin" },
    { id: 16, attribute: "Fog lamp L.H.S." },
    { id: 17, attribute: "Fog lamp R.H.S." },
    { id: 18, attribute: "Trim molding / crome line" },
  ];
