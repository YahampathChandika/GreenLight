...
function RearDoorLHS() {
  ...
  const data = [
    ...
    { id: 7, attribute: "Trim molding / Crome lines" },
    { id: 8, attribute: "Window Glass" },
    { id: 9, attribute: "Weatherstrip" },
    { id: 10, attribute: "Handle / Lock" },
    { id: 11, attribute: "Rubber seeling strips" },
    { id: 12, attribute: "Upholstery" },
    { id: 13, attribute: "Hingers" },
    { id: 14, attribute: "B pillar" },
    { id: 15, attribute: "C pillar" },
    { id: 16, attribute: "Elignment" },
    { id: 17, attribute: "No evidence of major damage" },
    { id: 18, attribute: "No re paint" },
    { id: 19, attribute: "Existing paint condition" },
    { id: 20, attribute: "No scratches" },
    { id: 21, attribute: "No corrosion" },
    { id: 22, attribute: "Trim molding / Crome lines" },
    { id: 23, attribute: "Window Glass" },
    { id: 24, attribute: "Weatherstrip" },
    { id: 25, attribute: "Handle / Lock" },
    { id: 26, attribute: "Rubber seeling strips" },
    { id: 27, attribute: "Upholstery" },
    { id: 28, attribute: "Hingers" },
    { id: 29, attribute: "B pillar" },
    { id: 30, attribute: "C pillar" },
  ];
