...
function ScanningReport() {
  ...
  const data = [
    ...
    { id: 18, attribute: "No trouble cord" },
    { id: 19, attribute: "Air temporature sensor" },
    { id: 20, attribute: "Map / Air flow sensor" },
    { id: 21, attribute: "Knock sensor" },
    { id: 22, attribute: "Engine coolent temperature sensor" },
    { id: 23, attribute: "O2 sensor 1" },
    { id: 24, attribute: "O2 sensor 2" },
    { id: 25, attribute: "Throttle position sensor" },
    { id: 26, attribute: "Accelarator paddle sensor" },
    { id: 27, attribute: "Power steering load sensor" },
    { id: 28, attribute: "Break switch sensor" },
    { id: 29, attribute: "A/C switch and clutch" },
    { id: 30, attribute: "Reverse gear switch sensor" },
    { id: 31, attribute: "12V battery voltage" },
    { id: 32, attribute: "Electric load" },
    { id: 33, attribute: "Engine RPM" },
    { id: 34, attribute: "Fuel injection time" },
  ];
