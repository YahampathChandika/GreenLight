...
function StartingDelay() {
  ...
  const data = [
    ...
    { id: 11, attribute: "Engine compressors" },
    { id: 12, attribute: "Heater plug" },
    { id: 13, attribute: "Filter head and fuel system" },
    { id: 14, attribute: "Filter and fuel pump" },
    { id: 15, attribute: "Injector pump" },
    { id: 16, attribute: "Injectors" },
    { id: 17, attribute: "Starter motor" },
    { id: 18, attribute: "12V battery" },
    { id: 19, attribute: "Electrical" },
    { id: 20, attribute: "No delay starting" },
  ];
