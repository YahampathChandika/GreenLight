...
function Suspension() {
  ...
  const data = [
    ...
    { id: 13, attribute: "Shocks and shock mount" },
    { id: 14, attribute: "Stabalizer links" },
    { id: 15, attribute: "Stabalizer bar bushes" },
    { id: 16, attribute: "Steering rack" },
    { id: 17, attribute: "Lower arm ball joints and bushes" },
    { id: 18, attribute: "Upper arm ball joints and bushes" },
    { id: 19, attribute: "Caliper pins" },
    { id: 20, attribute: "Tie bar bushes" },
    { id: 21, attribute: "Coil springs / leaf springs" },
    { id: 22, attribute: "Wheel bearing" },
    { id: 23, attribute: "Tyres" },
    { id: 24, attribute: "Steering linkages and rods" },
  ];
