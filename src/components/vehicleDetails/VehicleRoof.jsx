...
function VehicleRoof() {
  ...
  const data = [
    ...
    { id: 7, attribute: "Roof rail" },
    { id: 8, attribute: "Rain gutters" },
    { id: 9, attribute: "Shark Fin Antenna" },
    { id: 10, attribute: "Elignment" },
    { id: 11, attribute: "No evidence of major damage" },
    { id: 12, attribute: "No re paint" },
    { id: 13, attribute: "Existing paint condition" },
    { id: 14, attribute: "No scratches" },
    { id: 15, attribute: "No corrosion" },
    { id: 16, attribute: "Roof rail" },
    { id: 17, attribute: "Rain gutters" },
    { id: 18, attribute: "Shark Fin Antenna" },
  ];
